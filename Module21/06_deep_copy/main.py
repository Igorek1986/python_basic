...
# TODO Для вывода структуры сайта, в функцию стоит написать ещё одну функцию. И добавить в неё параметр «количество пробелов».
...
#  Если да, выводим ключ и его значением текущим «количеством пробелов» и проваливаемся глубже, увеличивая «количество пробелов».
